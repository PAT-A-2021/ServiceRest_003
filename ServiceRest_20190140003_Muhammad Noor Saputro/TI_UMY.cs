...
namespace ServiceRest_20190140003_Muhammad_Noor_Saputro
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=LAPTOP-5RML75UV;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa; Password=12345678910 ");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=LAPTOP-5RML75UV;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa; Password=12345678910 ");
